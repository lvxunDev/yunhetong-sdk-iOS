...
- (IBAction)preView_Action:(id)sender {
    [self.navigationController pushViewController:[YHTSDKDemoConfirmViewController instanceWithIsPreView:YES] animated:YES];
}

- (IBAction)partyA_Action:(id)sender {

    [self.navigationController pushViewController:[YHTSDKDemoConfirmViewController instanceWithIsPreView:NO] animated:YES];
}
