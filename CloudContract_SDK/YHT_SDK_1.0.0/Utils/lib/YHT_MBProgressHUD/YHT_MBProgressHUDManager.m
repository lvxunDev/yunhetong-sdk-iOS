...
#import "YHT_MBProgressHUDManager.h"

@implementation YHT_MBProgressHUDManager
...
- (void)createHUD
{
    if (!self.HUD)
    {
        self.HUD = [[YHT_MBProgressHUD alloc] initWithView:self.baseView];
...
- (void)hudWasHidden:(YHT_MBProgressHUD *)hud
{
